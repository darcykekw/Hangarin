"""
Django settings for hangarinorg project.
...
ALLOWED_HOSTS = ['darcykekw.pythonanywhere.com', '127.0.0.1', 'localhost']
...
if "pythonanywhere" in socket.gethostname():
    SITE_ID = 5 # production site (darcykekw.pythonanywhere.com)
else:
